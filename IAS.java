...
public class IAS {
	...
	public IAS(String nombreIA, int añoCreacion, int velocidad, String tipo, String creador, int cantidadMejoras) {
	...
	public String toString() {
		return "IAS [nombreIA=" + nombreIA + ", añoCreacion=" + añoCreacion + ", velocidad=" + velocidad + ", tipo="
				+ tipo + ", creador=" + creador + ", cantidadMejoras=" + cantidadMejoras + "]";
	}
