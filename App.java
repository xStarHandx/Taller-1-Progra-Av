...
public class App {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		menuR2(infoCreadores,infoIas,mxIa,mxCreador,mxUsuario,leer);
		leer.close();
	}
	
	private static void menuR2(double[][]infoCreadores,double[][]infoIas,String[][]mxIa,String[][]mxCreador,String[][]mxUsuario,Scanner leer) {
		...
		while((nombre.equals("-1")==false)) {
			...
			if(pos!=-1) {
				...
				verificadorUsuario(infoCreadores,infoIas,mxIa,mxCreador,mxUsuario,contraseña, pos,leer);
			}else {
	...
	private static void verificadorUsuario(double[][]infoCreadores,double[][]infoIas,String[][]mxIa,String[][]mxCreador,String[][]mxUsuario,String contraseña, int pos,Scanner leer) {
		String aux= mxUsuario[pos][1];
		if(contraseña.equals(aux)) {
			String tipo= mxUsuario[pos][2].toLowerCase();
			System.out.println(tipo);
			if(tipo.equals("administrador")) {
				desplegarMenuAdmin(infoCreadores,infoIas,mxCreador,mxUsuario,mxIa,leer);
			}
	...
	//-----------------------------------------ADMINISTRADOR---------------------------------------------------------------------------
	private static void desplegarMenuAdmin(double[][]infoCreadores,double[][]infoIas,String[][]mxCreador,String[][]mxUsuario,String[][]mxIa,Scanner leer) {
		...
		if(opcion==1) {
			...
			submenuReportes(infoCreadores,infoIas,mxCreador,mxIa,mxUsuario,leer);
		}
	}
	...
	private static void submenuReportes(double[][]infoCreadores,double[][]infoIas,String[][]mxCreador,String[][]mxIa,String[][]mxUsuario,Scanner leer) {
		tipoUsuario(mxUsuario,leer);
		//añadirUsuarioCreador();
		//editarDatosUsuarioCreador();
		//eliminarUsuarioCreador();
		reportesPantalla(infoCreadores,infoIas,mxCreador,mxIa);
		
	}
	private static void reportesPantalla(double[][]infoCreadores,double[][]infoIas,String[][]mxCreador,String[][]mxIa) {
