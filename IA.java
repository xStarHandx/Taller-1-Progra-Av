...
public class IA {
	...
	public IA(String nombreIA, int añoCreacion, int velocidad, String tipo, String creador, int cantidadMejoras) {
	...
	public String toString() {
		return "IA [nombreIA=" + nombreIA + ", añoCreacion=" + añoCreacion + ", velocidad=" + velocidad + ", tipo="
